...
public class EfficiencyExamples {
	...
	public static void main(String[] args) {
		...
		int[] numList = new int[] {1,2,3,5,4};
		System.out.println(missingNum(numList));
	...
	public static int missingNum (int[] numList) {
		int sumTotal = 0;
		int num = 1;
		while(num <= numList.length + 1) {
			sumTotal += num;
			num += 1;
		}
