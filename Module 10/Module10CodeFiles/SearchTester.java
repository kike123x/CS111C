...
// 		System.out.println("Location is " + location);
			...
			// Comparable[] numbers = new Integer[] {};
			// System.out.println(Searches.findIndicesRecursiveSorted(numbers, 1));

			int[] nums = new int[] {3, 5, 8, 9, 12, 14, 18, 19, 21, 23, 24, 26};
			System.out.println(Searches.binarySearchRecursive(nums, 16));
	}
