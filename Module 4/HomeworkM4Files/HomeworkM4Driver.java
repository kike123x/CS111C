...
public class HomeworkM4Driver {
	...
	public static void main(String[] args) {
		...
		// 	resizableBag.add(1);
		// }
		// // System.out.println(resizableBag.getCurrentSize());
		...
		// System.out.println("The length of the bag array is 160: " + resizableBag.getBagSize());
		// resizableBag.trimToSize();
		// System.out.println("The length of the bag array is 100: " + resizableBag.getBagSize());
